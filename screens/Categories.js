...
const Categories = ({ navigation }) => {
    ...
    return (
        ...
        >
        <ImageBackground source={require("./../assets/fondoInt.png")} resizeMode="cover" style={Global.image}></ImageBackground>
            ...
            {categories.length !== 0 ? <FlatList
                ...
                renderItem={({ item }) => {
                    ...
                    >
                        <Text style={Global.textButton2} >{item.nombre}</Text>

                    </TouchableOpacity>
                }}
            /> : <ActivityIndicator size={'large'} color={'blue'} />}
            <TouchableOpacity style={Global.btn} onPress={handleSignOut}>
                <Text style={Global.textButton}> Sign out  </Text>
            </TouchableOpacity>
